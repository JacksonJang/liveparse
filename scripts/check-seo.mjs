...
const requiredPages = [
  ...
  { relativePath: 'compress-image-to-20kb/index.html', canonical: `${CANONICAL_ORIGIN}/compress-image-to-20kb/`, label: 'compress image to 20 KB page', requireJson: false, requireParsing: false, requireJsonLd: true, minimumCharacters: 800, topicPattern: /(?=.*\bcompress)(?=.*\b20\s*KB\b)/i, topicLabel: 'compressing to 20 KB' },
  { relativePath: 'compress-image-to-50kb/index.html', canonical: `${CANONICAL_ORIGIN}/compress-image-to-50kb/`, label: 'compress image to 50 KB page', requireJson: false, requireParsing: false, requireJsonLd: true, minimumCharacters: 800, topicPattern: /(?=.*\bcompress)(?=.*\b50\s*KB\b)/i, topicLabel: 'compressing to 50 KB' },
  { relativePath: 'compress-image-to-100kb/index.html', canonical: `${CANONICAL_ORIGIN}/compress-image-to-100kb/`, label: 'compress image to 100 KB page', requireJson: false, requireParsing: false, requireJsonLd: true, minimumCharacters: 800, topicPattern: /(?=.*\bcompress)(?=.*\b100\s*KB\b)/i, topicLabel: 'compressing to 100 KB' },
  { relativePath: 'compress-image-to-200kb/index.html', canonical: `${CANONICAL_ORIGIN}/compress-image-to-200kb/`, label: 'compress image to 200 KB page', requireJson: false, requireParsing: false, requireJsonLd: true, minimumCharacters: 800, topicPattern: /(?=.*\bcompress)(?=.*\b200\s*KB\b)/i, topicLabel: 'compressing to 200 KB' },
  { relativePath: 'compress-image-to-500kb/index.html', canonical: `${CANONICAL_ORIGIN}/compress-image-to-500kb/`, label: 'compress image to 500 KB page', requireJson: false, requireParsing: false, requireJsonLd: true, minimumCharacters: 800, topicPattern: /(?=.*\bcompress)(?=.*\b500\s*KB\b)/i, topicLabel: 'compressing to 500 KB' },
  { relativePath: 'compress-image-to-1mb/index.html', canonical: `${CANONICAL_ORIGIN}/compress-image-to-1mb/`, label: 'compress image to 1 MB page', requireJson: false, requireParsing: false, requireJsonLd: true, minimumCharacters: 800, topicPattern: /(?=.*\bcompress)(?=.*\b1\s*MB\b)/i, topicLabel: 'compressing to 1 MB' },
