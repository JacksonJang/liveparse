...
const ROUTE_REDIRECTS = new Map([
  ...
  ['/discord-time-generator/', '/discord-timestamp-generator/'],
  ['/discord-snowflake-converter', '/discord-timestamp-generator/'],
  ['/discord-snowflake-converter/', '/discord-timestamp-generator/'],
  ['/discord-message-id-converter', '/discord-timestamp-generator/'],
  ['/discord-message-id-converter/', '/discord-timestamp-generator/'],
  ['/discord-id-converter', '/discord-timestamp-generator/'],
  ['/discord-id-converter/', '/discord-timestamp-generator/'],
